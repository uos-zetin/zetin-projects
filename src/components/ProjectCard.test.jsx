...
const p = {
  ...
  summary: '빠른 로봇', thumbnail: 'data/images/x.jpg',
};

describe('ProjectCard', () => {
  it('제목/연도/요약을 렌더링한다', () => {
    render(<ProjectCard project={p} onSelect={() => {}} />);
    expect(screen.getByText('라인트레이서')).toBeInTheDocument();
  ...
  it('클릭하면 onSelect를 project로 호출한다', async () => {
    ...
    render(<ProjectCard project={p} onSelect={onSelect} />);
